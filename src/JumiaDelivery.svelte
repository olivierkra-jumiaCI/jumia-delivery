            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-gray-400 max-w-md leading-relaxed">
                        Jumia Delivery est le premier réseau de livraison de colis en Côte d'Ivoire. Nous connectons les familles et les entreprises grâce à un service fiable, rapide et abordable.
                    </p>
                </div>
                <div>
                    <h4 class="text-lg font-bold mb-6">Navigation</h4>
                    <ul class="space-y-4 text-gray-400">
                        <li><a href="#tarifs" class="hover:text-jumia-orange transition">Tarification</a></li>
                        <li><a href="#points-relais" class="hover:text-jumia-orange transition">Points Relais</a></li>
                        <li><button on:click={() => onNavigate('business')} class="hover:text-jumia-orange transition bg-transparent p-0 text-left border-none cursor-pointer">Espace Vendeur</button></li>
